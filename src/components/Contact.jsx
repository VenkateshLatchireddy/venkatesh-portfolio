...
export default function Contact({ isVisible }) {
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappURL = `https://wa.me/918142244668?text=${encodedMessage}`
    ...
    <div className="col-10 col-sm-6 col-md-4">
      ...
      >
        <div className="card-body text-center">
          ...
          <a href="https://github.com/VenkateshLatchireddy" target="_blank" className="stretched-link text-decoration-none" />
        </div>
      </div>
    </div>
    ...
    <div className="col-10 col-sm-6 col-md-4">
      ...
      >
        <div className="card-body text-center">
          ...
          <a href="https://www.linkedin.com/in/venkatesh-lachireddi-8160431b4/" target="_blank" className="stretched-link text-decoration-none" />
        </div>
      </div>
    </div>
...
<div className="col-10 col-sm-6 col-md-4">
  ...
  >
    <a
      href="mailto:venkatesh.lachireddi@gmail.com"
