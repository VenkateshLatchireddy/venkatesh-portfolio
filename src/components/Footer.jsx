        ...
        <div className="row g-5">
          ...
          <div className="col-md-6 col-lg-3">
            ...
            <p className="d-flex align-items-center text-secondary">
              ...
              <a href="mailto:venkatesh.lachireddi@gmail.com" className="text-decoration-none text-secondary">
                venkatesh.lachireddi@gmail.com
              </a>
            </p>
            <p className="d-flex align-items-center text-secondary">
            ...
            <div className="d-flex gap-3 mt-3">
              <a href="https://github.com/VenkateshLatchireddy" target="_blank" className="text-light">
                <Github />
              </a>
              <a href="https://www.linkedin.com/in/venkatesh-lachireddi-8160431b4/" target="_blank" className="text-light">
                <Linkedin />
              </a>
              <a href="https://www.instagram.com/venky4creator/" target="_blank" className="text-light">
                <Instagram />
              </a>
            </div>
          </div>
