...
export default function About({ isVisible }) {
  ...
  ></div>
              ...
              <p className="lead mb-3" style={{ color: "#4a5568" }}>
                I'm a passionate <strong>Full Stack Web Developer</strong> experienced in building responsive web apps that solve real problems and deliver elegant user experiences.
              </p>
